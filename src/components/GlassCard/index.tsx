...
// Cards read this to know they're the active/expanded card in the bento grid
...
export function GlassCard({
  ...
  return (
    <div className="relative overflow-hidden rounded-none glass-outer" style={outerStyle}>
      <div className="absolute rounded-full pointer-events-none z-0 h-px" style={specularStyle} />
      <div className="absolute rounded-none overflow-hidden glass-inner" style={innerStyle}>
        <div className="absolute pointer-events-none z-0" style={glowStyle} />
